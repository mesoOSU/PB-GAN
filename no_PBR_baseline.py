...
This is code the baseline for comparison to other PBR methods 
"""
...
save_npz_name = 'no_PBR_DLR=0.0001_GLR=0.00025_DWT=0.5_MSE=200'
...
def define_gan(g_model, image_shape):
	...
	# compile model
    optg = Adam(learning_rate=0.00025, beta_1=0.5) 
    model.compile(loss=['binary_crossentropy', 'mse'], optimizer=optg, loss_weights=[1,200])
    return model
