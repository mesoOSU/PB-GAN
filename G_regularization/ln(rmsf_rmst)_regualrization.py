# -*- coding: utf-8 -*-
"""
Created on Mon Oct 18 12:07:30 2021
...
this code regularizes the generator by adding ln(RMSf1/RMSt1) + ln(RMSf2/RMSt2) to the GAN loss
"""
...
def stress_loss_fn2(y_true, y_pred):
    ...
    loss1 = tf.math.log(lossi/Tlossi) + tf.math.log(lossii/Tlossii)             # Ln(RMSf1/RMSt1) + ln(RMSf2/RMSt2) regualrization
...
def define_gan(g_model, image_shape):
    ...
    model.compile(loss=['binary_crossentropy', stress_loss_fn2], optimizer=opt, loss_weights=[1,1])
    return model
